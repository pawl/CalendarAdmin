        ...
        for id in ids:
            ...
            if event_object:
                ...
                if not any(existing_events):
                    # IE will not copy links correctly with gcal's linebreaks
                    # Solution: use add_tags_to_urls to turn urls into tags
                    google_add_event_requestbody = {
                        ...
                        "summary": add_tags_to_urls(event_object.summary)
                    }
